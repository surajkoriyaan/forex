...
<main id="content">
<section class="pt-2 pb-10 pb-lg-17 page-title bg-overlay bg-img-cover-center" style="background-image: url('{{asset('homeassets/images/BG3.jpg')}}');">
<div class="container">
...
<span class="text-primary fs-90 lh-1"><svg class="icon icon-e1"><use xlink:href="#icon-e1"></use></svg></span>
</div>
