@include('header')
<main id="content">
<section class="py-16 page-title bg-white-overlay bg-img-cover-center" style="background-image: url('{{asset('homeassets/images/bg-title-04.jpg')}}');">
<div class="container">
...
<input type="text" id="search02" class="form-control form-control-lg border-0 shadow-none" placeholder="Search..." name="search">
...
<img src="{{asset('homeassets/images/download-brochure.png')}}" alt="Download Brochure">
<div class="text-center mt-10 mb-2">
<a href="#" class="btn btn-lg bg-gray-01 bg-hover-accent btn-block text-heading">Download
now<span class="text-primary d-inline-block ml-2"><i class="far fa-arrow-circle-down"></i></span></a>
</div>
</div>
</div>
<div class="card mb-4">
...
<a href="#" class="px-2 py-1 d-block fs-13 lh-17 bg-gray-03 text-muted hover-white bg-hover-primary rounded">designer</a>
</li>
<li class="list-inline-item mb-2">
<a href="#" class="px-2 py-1 d-block fs-13 lh-17 bg-gray-03 text-muted hover-white bg-hover-primary rounded">mockup</a>
</li>
<li class="list-inline-item mb-2">
<a href="#" class="px-2 py-1 d-block fs-13 lh-17 bg-gray-03 text-muted hover-white bg-hover-primary rounded">template</a>
</li>
<li class="list-inline-item mb-2">
<a href="#" class="px-2 py-1 d-block fs-13 lh-17 bg-gray-03 text-muted hover-white bg-hover-primary rounded">IT
Security</a>
</li>
<li class="list-inline-item mb-2">
<a href="#" class="px-2 py-1 d-block fs-13 lh-17 bg-gray-03 text-muted hover-white bg-hover-primary rounded">IT
...
<li class="list-inline-item mb-2">
<a href="#" class="px-2 py-1 d-block fs-13 lh-17 bg-gray-03 text-muted hover-white bg-hover-primary rounded">business</a>
</li>
<li class="list-inline-item mb-2">
<a href="#" class="px-2 py-1 d-block fs-13 lh-17 bg-gray-03 text-muted hover-white bg-hover-primary rounded">videos</a>
</li>
<li class="list-inline-item mb-2">
<a href="#" class="px-2 py-1 d-block fs-13 lh-17 bg-gray-03 text-muted hover-white bg-hover-primary rounded">wordpress
theme</a>
</li>
<li class="list-inline-item mb-2">
<a href="#" class="px-2 py-1 d-block fs-13 lh-17 bg-gray-03 text-muted hover-white bg-hover-primary rounded">sketch</a>
</li>
</ul>
</div>
</div>
...
<img src="{{asset('homeassets/images/post-15.jpg')}}" alt="Future Office Buldings Intelligent by Design">
</a>
...
<a class="text-heading font-weight-500" href="blog-details-1.html">Learn
...
<div class="position-relative d-flex align-items-end card-img-top">
<a href="blog-details-1.html" class="hover-shine">
<img src="{{asset('homeassets/images/post-21.jpg')}}" alt="The Interior Design The Hall On str. Filimonovo">
</a>
<a href="#" class="badge text-white bg-dark-opacity-04 fs-13 font-weight-500 bg-hover-primary hover-white mx-2 my-4 position-absolute pos-fixed-bottom">
rentals
</a>
...
<div class="position-relative d-flex align-items-end card-img-top">
<a href="blog-details-1.html" class="hover-shine">
<img src="{{asset('homeassets/images/post-18.jpg')}}" alt="Future Office Buldings Intelligent by Design">
</a>
<a href="#" class="badge text-white bg-dark-opacity-04 fs-13 font-weight-500 bg-hover-primary hover-white mx-2 my-4 position-absolute pos-fixed-bottom">
rentals
</a>
...
<div class="position-relative d-flex align-items-end card-img-top">
<a href="blog-details-1.html" class="hover-shine">
<img src="{{asset('homeassets/images/post-17.jpg')}}" alt="Ten Benefits Of Rentals That May Change Your Perspective">
</a>
<a href="#" class="badge text-white bg-dark-opacity-04 fs-13 font-weight-500 bg-hover-primary hover-white mx-2 my-4 position-absolute pos-fixed-bottom">
rentals
</a>
...
<div class="position-relative d-flex align-items-end card-img-top">
<a href="blog-details-1.html" class="hover-shine">
<img src="{{asset('homeassets/images/post-19.jpg')}}" alt="Future Office Buldings Intelligent by Design">
</a>
<a href="#" class="badge text-white bg-dark-opacity-04 fs-13 font-weight-500 bg-hover-primary hover-white mx-2 my-4 position-absolute pos-fixed-bottom">
creative
</a>
...
<div class="position-relative d-flex align-items-end card-img-top">
<a href="blog-details-1.html" class="hover-shine">
<img src="{{asset('homeassets/images/post-22.jpg')}}" alt="The Interior Design The Hall On str. Filimonovo">
 </a>
<a href="#" class="badge text-white bg-dark-opacity-04 fs-13 font-weight-500 bg-hover-primary hover-white mx-2 my-4 position-absolute pos-fixed-bottom">
rentals
</a>
...
<div class="position-relative d-flex align-items-end card-img-top">
<a href="blog-details-1.html" class="hover-shine">
<img src="{{asset('homeassets/images/post-20.jpg')}}" alt="Ten Benefits Of Rentals That May Change Your Perspective">
</a>
<a href="#" class="badge text-white bg-dark-opacity-04 fs-13 font-weight-500 bg-hover-primary hover-white mx-2 my-4 position-absolute pos-fixed-bottom">
rentals
</a>
...
<div class="position-relative d-flex align-items-end card-img-top">
<a href="blog-details-1.html" class="hover-shine">
<img src="{{asset('homeassets/images/post-23.jpg')}}" alt="The Interior Design The Hall On str. Filimonovo">
</a>
<a href="#" class="badge text-white bg-dark-opacity-04 fs-13 font-weight-500 bg-hover-primary hover-white mx-2 my-4 position-absolute pos-fixed-bottom">
rentals
</a>
