...
@endphp
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">Account Manager And Signal Provider</h4><span class="text-muted mt-1 tx-13 ml-2 mb-0">/ Profile</span>
						</div>
					</div>
								...
								<div class="pl-0">
									<div class="main-profile-overview">
										<div class="main-img-user profile-user">
											<img alt="" src="{{asset('uploads/account_and_signal/logo/'.$logo)}}" alt="logo"><a class="fas fa-camera profile-edit" href="JavaScript:void(0);"></a>
										</div>
													 ...
													 <div class="row">
														 ...
														 for($i=0;$i<$cd;$i++){
															 ...
															 <div class="col-md-6" style="height:auto">
																<img src="{{asset('uploads/account_and_signal/image_gallery/'.$imgss[$i])}}" style="height:100%;width:100%" alt="">
															</div>
															 @php
														 }
														 @endphp
										...
										<div class="card">
											<div class="card-body h-100">
												<div class="card-header">
													<div class="media">
														<div class="media-body">
															<h6 class="mb-0 mg-t-9">Minimum Equity</h6>
															<span class="text-dark">{{$minimum_equity}}</span>
														</div>
													</div>
													<div class="media" style="margin-top: 5px">
														<div class="media-body">
															<h6 class="mb-0 mg-t-9">Profit Sharing</h6>
															<span class="text-dark">{{$profit_sharing}}</span>
														</div>
													</div>
													<div class="media" style="margin-top: 5px">
														<div class="media-body">
															<h6 class="mb-0 mg-t-9">Currency Pairs</h6>
															<span class="text-dark">{{$currency_pair}}</span>
														</div>
													</div>
													<div class="media" style="margin-top: 5px">
														<div class="media-body">
															<h6 class="mb-0 mg-t-9">Trading Plateform</h6>
															<span class="text-dark">{{$trading_plateform}}</span>
														</div>
													</div>
													<div class="media" style="margin-top: 5px">
														<div class="media-body">
															<h6 class="mb-0 mg-t-9">Tradable Assets</h6>
															<span class="text-dark">{{$tradable_assets}}</span>
														</div>
													</div>
													<div class="media" style="margin-top: 5px">
														<div class="media-body">
															<h6 class="mb-0 mg-t-9">Minimum Deposit</h6>
															<span class="text-dark">{{$minimum_deposit}}</span>
														</div>
													</div>
													<div class="media" style="margin-top: 5px">
														<div class="media-body">
															<h6 class="mb-0 mg-t-9">Forex Brokers</h6>
															<span class="text-dark">{{$forex_bokers}}</span>
														</div>
													</div>
												</div>
												<p class="mg-t-10">
													 <h6>Investor Id & Password Details</h6>
													{!! $investor_id !!}
												</p>
											</div>
										</div>
