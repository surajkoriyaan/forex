	...
	<body class="main-body app sidebar-mini Light-mode">
		...
		<aside class="app-sidebar sidebar-scroll ">
			<div class="main-sidebar-header">
				<a class=" desktop-logo logo-light" href="{{url('signal-provider-home')}}"><img src="{{asset('agentasset/assets/img/brand/logo.png')}}" class="main-logo" alt="logo"></a>
				<a class=" desktop-logo logo-dark" href="{{url('signal-provider-home')}}"><img src="{{asset('agentasset/assets/img/brand/logo-white.png')}}" class="main-logo dark-theme" alt="logo"></a>
				<a class="logo-icon mobile-logo icon-light" href="{{url('signal-provider-home')}}"><img src="{{asset('agentasset/assets/img/brand/favicon.png')}}" class="logo-icon" alt="logo"></a>
				<a class="logo-icon mobile-logo icon-dark" href="{{url('signal-provider-home')}}"><img src="{{asset('agentasset/assets/img/brand/favicon-white.png')}}" class="logo-icon dark-theme" alt="logo"></a>
			</div>
			<div class="main-sidebar-body circle-animation ">
				...
				<ul class="side-menu circle">
					...
					<li class="slide">
						<a class="side-menu__item" href="{{url('signal-provider-home')}}"><i class="side-menu__icon ti-desktop"></i><span class="side-menu__label">Dashboard</span></a>
					</li>
                    <li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{url('signal-provider-profile')}}"><i class="side-menu__icon ti-layout menu-icon"></i><span class="side-menu__label">Profile</span><i class="angle fe fe-chevron-down"></i></a>
		...
		<!-- main-sidebar -->
				...
				<div class="container-fluid">
					...
					<div class="main-header-center">
						<div class="responsive-logo">
							<a href="{{url('signal-provider-home')}}">
						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								...
								<div class="dropdown-menu dropdown-menu-arrow animated fadeInUp">
									...
									<a class="dropdown-item" href="{{url('signal-provider-home')}}"><i class="far fa-user"></i> My Profile</a>
									<a class="dropdown-item" href="{{url('signal-provider-profile')}}"><i class="far fa-edit"></i> Edit Profile</a>
	      ...
	      $trading_stratergy=$account->trading_stratergy ?? null;
				...
				<div class="row">
					<form class="" action="{{url('signal-provideruser-details')}}" method="post" enctype="multipart/form-data" style="width: 100%">
           @csrf
                      ...
                      $nam=explode(" ",$nameass);
									...
									<div class="row row-sm mg-t-20">
										...
										<div class="custom-file">
											<div class="col-sm-12 col-md-3 mg-t-10 mg-sm-t-0">
												<input type="file" name="logo" class="dropify" data-default-file="{{asset('uploads/signal_provider/logo/'.$logo)}}" />
											</div>
											</div>
										</div>
									</div>
                        ...
                        $imgarr=explode(",",$image_gallery);
											...
											<div class="col-sm-12 col-md-3">
												<input type="file" name="imagegallery[]" class="dropify" data-default-file="{{asset('uploads/signal_provider/image_gallery/'.$imggal)}}" />
											</div>
													@php
												}
												@endphp
					     ...
					     <div class="card-body">
					       ...
					       <div class="row row-sm mg-t-20">
					         <div class="col-lg">
					           ...
					           <textarea name="trading_stratergy" id="investerid" class="form-control" rows="4">{{$trading_stratergy}}</textarea>
					           </div>
					       </div>
					     </div>
					   </div>
 	 ...
 	 var editor=CKEDITOR.replace('fulladdress',{
 	     filebrowserUploadUrl:"{{route('signalckeditorimage.upload',['_token'=>csrf_token()])}}",
