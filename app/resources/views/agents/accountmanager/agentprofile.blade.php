	...
	<body class="main-body app sidebar-mini Light-mode">
		...
		<aside class="app-sidebar sidebar-scroll ">
			...
			<div class="main-sidebar-body circle-animation ">
				...
				<ul class="side-menu circle">
                    ...
                    <li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{url('agent-profile')}}"><i class="side-menu__icon ti-layout menu-icon"></i><span class="side-menu__label">Profile</span><i class="angle fe fe-chevron-down"></i></a>
		...
		<!-- main-sidebar -->
	      ...
	      $investor_id=$account->investor_id ?? null;
				...
				<div class="row">
					<form class="" action="{{url('agent-account-details')}}" method="post" enctype="multipart/form-data" style="width: 100%">
           @csrf
                      ...
                      $nam=explode(" ",$nameass);
									...
									<div class="row row-sm mg-t-20">
										...
										<div class="custom-file">
											<div class="col-sm-12 col-md-3 mg-t-10 mg-sm-t-0">
												<input type="file" name="logo" class="dropify" data-default-file="{{asset('uploads/acount_manager/logo/'.$logo)}}" />
											</div>
											</div>
										</div>
									</div>
                        ...
                        $imgarr=explode(",",$image_gallery);
											...
											<div class="col-sm-12 col-md-3">
												<input type="file" name="imagegallery[]" class="dropify" data-default-file="{{asset('uploads/acount_manager/image_gallery/'.$imggal)}}" />
											</div>
													@php
												}
												@endphp
	 ...
	 var editor=CKEDITOR.replace('fulladdress',{
	     filebrowserUploadUrl:"{{route('ckeditorimage.upload',['_token'=>csrf_token()])}}",
