@include('agents/accountmanager/header')
...
@endphp
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">Account Manager</h4><span class="text-muted mt-1 tx-13 ml-2 mb-0">/ Profile</span>
						</div>
					</div>
								...
								<div class="pl-0">
									<div class="main-profile-overview">
										<div class="main-img-user profile-user">
											<img alt="" src="{{asset('uploads/acount_manager/logo/'.$logo)}}" alt="logo"><a class="fas fa-camera profile-edit" href="JavaScript:void(0);"></a>
										</div>
                             ...
                             $cd=count($imgss);
														 for($i=0;$i<$cd;$i++){
															 ...
															 <div class="col-md-6" style="height:auto">
 														 		<img src="{{asset('uploads/acount_manager/image_gallery/'.$imgss[$i])}}" style="height:100%;width:100%" alt="">
 														 	</div>
															 @php
														 }
														 @endphp
			...
			<!-- main-content closed -->
@include('agents/accountmanager/footer')
