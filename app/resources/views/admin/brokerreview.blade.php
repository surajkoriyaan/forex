                                    ...
                                    <div class="card-body">
                                        ...
                                        <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                            ...
                                            <tbody>
                                              ...
                                              <tr>
                                                  <td>{{$value['name']}}</td>
                                                  <td><img src="{{ asset('uploads/broker/'.$value['logo']) }}" style="height: 40px;width: 40px" alt=""></td>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              <form class="" action="{{route('broker.delete')}}" method="post">
                @csrf
                ...
                <button type="submit" class="btn btn-primary">Yes, delete</button>
                                                ...
                                                <a href="{{url('broker-show-details/'.$value['id'])}}" style="color: blue; font-size: 18px">
