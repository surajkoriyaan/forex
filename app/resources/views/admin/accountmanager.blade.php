...
<script>tinymce.init({selector:'#anc'});</script>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Account Manager Registration</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                      <form class="" action="{{route('account.manager.insert')}}" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="text" class="form-control" name="minimum_equity" value="">
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6">
                                                                <div class="mb-3">
                                                                    <label>Profit Sharing</label>
                                                                    <input type="text" class="form-control" name="profitsharing" value="">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-lg-6">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="text" class="form-control" name="currencypairs" id="basicpill-cardno-input">
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6">
                                                                <div class="mb-3">
                                                                    <label for="basicpill-card-verification-input">Trading Plateform</label>
                                                                    <input type="text" class="form-control" name="tradingplateform" id="basicpill-card-verification-input">
                                                                </div>
                                                            </div>
                                                        </div>
                                                         <div class="row">
                                                            <div class="col-lg-6">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="text" class="form-control" name="tradableassets" id="basicpill-cardno-input">
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6">
                                                                <div class="mb-3">
                                                                    <label for="basicpill-card-verification-input">Minimum Deposit</label>
                                                                    <input type="text" class="form-control" name="minimum_deposit" id="basicpill-card-verification-input">
                                                                </div>
                                                            </div>
                                                        </div>
                                                         <div class="row">
                                                            <div class="col-lg-12">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="text" class="form-control" name="forex_broker" id="basicpill-cardno-input">
                                                                </div>
                                                            </div>
                                                         ...
                                                         <div class="row">
                                                            <div class="col-lg-12">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <textarea class="form-control" name="investerid" id="investerid"></textarea>
                                                                    <!--<input type="text" class="form-control" name="investerid" id="basicpill-cardno-input">-->
                                                                </div>
                                                            </div>
                                                            <!--<div class="col-lg-6">-->
                                                            <!--    <div class="mb-3">-->
                                                            <!--        <label for="basicpill-card-verification-input"></label>-->
                                                            <!--        <input type="text" class="form-control" name="passworddetails" id="basicpill-card-verification-input">-->
                                                            <!--    </div>-->
                                                            <!--</div>-->
                                                        </div>
                                                  </div>
