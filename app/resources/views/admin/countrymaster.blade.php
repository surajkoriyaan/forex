                                ...
                                <div class="card">
                                    <div class="card-body">
                                      <button type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#myModal" style="float: right">Add New</button>
                                          <h4 class="card-title">Country Master</h4><br>
   ...
   <div class="modal-dialog">
     <div class="modal-content">
       ...
       <div class="modal-footer">
         <form class="" action="{{route('country.delete')}}" method="post">
           @csrf
                                                                     ...
                                                                     <div class="modal-dialog">
                                                                         <div class="modal-content">
                                                                             <div class="modal-header">
                                                                               ...
                                                                               <form class="custom-validation" action="{{route('countryupdate')}}" method="POST">
                                                                                 @csrf
                                                                                         ...
                                                                                         <div class="card-body">
                                                                                                 <div class="mb-3">
                                                                                                   <input type="hidden" name="id" value="{{$value['id']}}">
                                                                                                     ...
                                                                                                     <input type="text" name="countryname" value="{{$value['country_name']}}" class="form-control" required placeholder="country name" />
                                                                                                 </div>
                                                                                         </div>
                                                                                     </div>
                                                                                 </div> <!-- end col -->
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                          ...
                                                          <form class="custom-validation" action="{{route('country')}}" method="POST">
                                                            @csrf
                                                        <div class="modal-body">
                                                          <div class="row">
                                                            <div class="col-xl-12">
                                                                <div class="card">
                                                                    <div class="card-body">
                                                                            <div class="mb-3">
                                                                                <label class="form-label">Country Name</label>
                                                                                <input type="text" name="countryname" class="form-control" required placeholder="country name" />
                                                                            </div>
                                                                    </div>
                                                                </div>
                                                            </div> <!-- end col -->
