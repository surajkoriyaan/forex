...
<script>tinymce.init({selector:'#anc'});</script>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Account Manager Update</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                      <form class="" action="{{url('account-update')}}" method="post" enctype="multipart/form-data">
                                                 ...
                                                 <div id="inputFormRow">
                                                    ...
                                                    <div class="row">
                                                       ...
                                                       <div class="col-lg-6">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <img src="{{asset('uploads/acount_manager/logo/'.$acountdetails['logo'])}}" style="height:200px;width:auto"/>
                         ...
                         <br>
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="row">
                                                            ...
                                                            @for($j=0;$j<$cd;$j++)
                                                             <div class="col-lg-3">
                                                                 <img src="{{asset('uploads/acount_manager/image_gallery/'.$imggalery[$j])}}" style="height:auto;width:100%"/>
                                                             </div>
                                                            @endfor
                                                        </div>
