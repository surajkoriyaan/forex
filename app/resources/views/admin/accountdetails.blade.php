...
@endif
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">All Account Managers</h4>
                                        <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                            ...
                                            <tbody>
                                              ...
                                              <tr>
                                                  ...
                                                  <td><img src="{{ asset('uploads/acount_manager/logo/'.$value['logo']) }}" style="height: 40px;width: 40px" alt=""></td>
                                                  <td>{{$value['mobile']}}</td>
                                                  <td>{{$value['email']}}</td>
                                                  <td>{{$value['country']}}</td>
                                                  <td>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              <form class="" action="{{route('account.delete')}}" method="post">
                @csrf
                ...
                <button type="submit" class="btn btn-primary">Yes, delete</button>
                                                ...
                                                <a href="{{url('account-edit/'.$value['id'])}}" style="color: blue; font-size: 18px">
