...
<script>tinymce.init({selector:'#anc'});</script>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Signal Provider Update</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                      <form class="" action="{{url('signal-provider-update')}}" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" name="fname" class="form-control" value="{{$acountdetails['fname']}}" id="basicpill-firstname-input">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <div class="mb-3">
                                                                <label for="basicpill-firstname-input">Last Name</label>
                                                                <input type="text" name="lname" class="form-control" value="{{$acountdetails['lname']}}" id="basicpill-firstname-input">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-12">
                                                            <div class="mb-3">
                                                 ...
                                                 <div id="inputFormRow">
                                                    ...
                                                    <div class="row">
                                                       ...
                                                       <div class="col-lg-6">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <img src="{{asset('uploads/signal_provider/logo/'.$acountdetails['logo'])}}" style="height:200px;width:auto"/>
                                                    ...
                                                    <div class="row">
                                                          ...
                                                          <div class="row">
                                                            ...
                                                            <div class="col-md-8">
                                                              <div class="mb-3">
                                                                  ...
                                                                  <input type="number"  name="mobilenumber" class="form-control" value="{{$acountdetails['mobileno']}}">
                                                            </div>
                                                            </div>
                                                          </div>
                                                        </div>
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" name="telegramid" value="{{$acountdetails['telegramlink']}}" class="form-control" />
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <div class="mb-3">
                                                                <label for="basicpill-declaration-input">Facebook Id</label>
                                                                <input type="text" name="facebookid" value="{{$acountdetails['facebookid']}}" class="form-control" />
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <div class="mb-3">
                                                                <label for="basicpill-declaration-input">Instagram Id</label>
                                                                <input type="text" name="instagramid" value="{{$acountdetails['instagramid']}}"  class="form-control" />
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <div class="mb-3">
                                                                <label for="basicpill-declaration-input">Linkedin Id</label>
                                                                <input type="text" name="linkedinid" value="{{$acountdetails['linkedin']}}" class="form-control" />
                                                            </div>
                                                        </div>
                                                         <div class="col-lg-12">
                                                            <div class="mb-3">
                         ...
                         <br>
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="row">
                                                            ...
                                                            @for($j=0;$j<$cd;$j++)
                                                             <div class="col-lg-3">
                                                                 <img src="{{asset('uploads/signal_provider/image_gallery/'.$imggalery[$j])}}" style="height:auto;width:100%"/>
                                                             </div>
                                                            @endfor
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-12">
                                                                <div class="mb-3">
                                                                   ...
                                                                   <textarea name="stragery" id="stragery" class="form-control tinymce-editor">{{$acountdetails['trading_stratergy']}}</textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                  </div>
