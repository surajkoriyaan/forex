                  ...
                  <div class="breadcrumbs fw-breadcrumbs top-smpar smpar fl-wrap">
                      <div class="container">
                          <div class="breadcrumbs-list">
                              <a href="#">Home</a><a href="#">Account Manager</a><a href="#">{{$data->first_name . " ". $data->last_name}}</a>
                          </div>
                                        ...
                                        <div class="profile-widget-header color-bg smpar fl-wrap">
                                            ...
                                            <div class="profile-widget-card">
                                                <div class="profile-widget-image">
                                                    <img src="{{asset('uploads/acount_manager/logo/'.$data->logo)}}" alt="">
                                                </div>
                                                <div class="profile-widget-header-title">
                                                    <h4><a href="#">{{$data->first_name . " ". $data->last_name}}</a></h4>
                                        ...
                                        <div class="profile-widget-content fl-wrap">
                                            <div class="contats-list fl-wrap">
                                                <ul class="no-list-style">
                                                    <li><span><i class="fal fa-phone"></i> Phone :</span> <a href="#">{{$data->country_code . " ". $data->mobile}}</a></li>
                              ...
                              <div class="col-md-8">
                                  <div class="list-single-main-wrapper fl-wrap" style="padding-left: 0px;">
                                      ...
                                      <div class="list-single-header-item  fl-wrap" id="sec1">
                                          <div class="row">
                                              <div class="col-md-8">
                                                  <h1>{{$data->first_name . " ". $data->last_name}}<span class="verified-badge tolt" data-microtip-position="bottom"  data-tooltip="Verified"><i class="fas fa-check"></i></span></h1>
                                          ...
                                          <div class="list-single-main-item fl-wrap" id="sec3" style="overflow-x: scroll">
                                              ...
                                              <div class="rooms-container fl-wrap">
                                                  <table class="table">
                                                      <thead>
                                                        <tr>
                                                          <th scope="col">Minimum Equity</th>
                                                          <th scope="col">{{$data->minimum_equity}}</th>
                                                        </tr>
                                                        <tr>
                                                          <th scope="col">Profit Sharing</th>
                                                          <th scope="col">{{$data->profit_sharing}}</th>
                                                        </tr>
                                                         <tr>
                                                          <th scope="col">Currency Pairs</th>
                                                          <th scope="col">{{$data->currency_pair}}</th>
                                                        </tr>
                                                         <tr>
                                                          <th scope="col">Trading Plateform</th>
                                                          <th scope="col">{{$data->trading_plateform}}</th>
                                                        </tr>
                                                        <tr>
                                                          <th scope="col">Minimum Deposit</th>
                                                          <th scope="col">{{$data->minimum_deposit}}</th>
                                                        </tr>
                                                         <tr>
                                                          <th scope="col">Tradable Assets</th>
                                                          <th scope="col">{{$data->tradable_assets}}</th>
                                                        </tr>
                                                        <tr>
                                                          <th scope="col">Forex Brokers</th>
                                                          <th scope="col">{{$data->forex_bokers}}</th>
                                                        </tr>
                                                      </thead>
                                                    </table>
                                              </div>
                                          ...
                                          <div class="list-single-main-media fl-wrap">
                                            <div class="single-slider-wrapper carousel-wrap fl-wrap">
                                                ...
                                                <div class="slick-slide-item">
                                                        <div class="box-item">
                                                            <a href="{{asset('uploads/acount_manager/image_gallery/'.$imgarr[$i])}}" class="gal-link popup-image"><i class="fal fa-search"  ></i></a>
                                                            <img src="{{asset('uploads/acount_manager/image_gallery/'.$imgarr[$i])}}" alt="">
                                                        </div>
                                                    </div>
                                                @endfor
                                                </div>
                                            ...
                                            <div class="single-slider-wrapper fl-wrap">
                                                ...
                                                @endphp
                                                @for($i=0;$i<$img_c;$i++)
                                                 <div class="slick-slide-item"><img src="{{asset('uploads/acount_manager/image_gallery/'.$imgarr[$i])}}" style="height:200px" alt=""></div>
                                                @endfor
                                                </div>
                                            </div>
                                        </div>
                                              ...
                                              <div class="list-single-main-item_content fl-wrap">
                                                @if($data->video_gallery!='')
                                                  <div class="video-box fl-wrap">
                                                      <img src="{{asset('uploads/acount_manager/logo/'.$data->logo)}}" class="respimg" alt="">
